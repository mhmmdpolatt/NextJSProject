  ...
  return (
    <div className="w-2/3 ml-3">
      ...
      <div className="flex items-center justify-center gap-3 ">
        ...
        {filteredData.length === 0 ? <span className="text-white ">0 Sonuç || Tüm Turları <button className="underline" onClick={() => setMenuOpen(false)}><Link href="#Tours">Göster</Link></button></span> : null}
